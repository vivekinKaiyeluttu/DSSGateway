...
import com.dss.gateway.domain.Document;
import com.dss.gateway.repository.DocumentRepository;
...
/**
 * REST controller for managing {@link com.dss.gateway.domain.Document}.
 */
@RestController
@RequestMapping("/api")
@Transactional
